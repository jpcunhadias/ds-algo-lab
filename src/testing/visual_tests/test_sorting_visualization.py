...
def test_bubble_sort_visualization():
    ...
    for i, step in enumerate(steps[:5]):
        ...
        visualizer.save(f'test_outputs/bubble_sort_step_{i+1}.png')
...
def test_insertion_sort_visualization():
    ...
    for i, step in enumerate(steps[:5]):
        visualizer.visualize(arr, step)
        visualizer.save(f'test_outputs/insertion_sort_step_{i+1}.png')
...
def test_selection_sort_visualization():
    ...
    for i, step in enumerate(steps[:5]):
        visualizer.visualize(arr, step)
        visualizer.save(f'test_outputs/selection_sort_step_{i+1}.png')
